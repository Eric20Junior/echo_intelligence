...
// so data/models/node_modules must be siblings of the folder containing the
...
function main() {
  ...
  execFileSync(
    ...
    ["esbuild", "scripts/live-demo.js", "--bundle", "--platform=node", "--target=node20",
     "--external:better-sqlite3", "--external:node-llama-cpp", "--outfile=" + path.join(BIN_DIR, "app.js")],
